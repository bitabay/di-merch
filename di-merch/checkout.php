	...
	<section class="kontent">
		<div class="container">
			...
			if (isset($_POST["checkout"])) {
				...
				$stmt->bind_param("sssssss", $id_pelanggan, $id_ongkir, $tanggal_pembelian, $total_pembelian, $nama_kota, $tarif, $alamat_pengiriman);
				$stmt->execute();
				...
				foreach ($_SESSION["keranjang"] as $id_produk => $jumlah) {
					...
					$koneksi->query("INSERT INTO pembelian_produk (
						id_pembelian, id_produk, nama, harga, berat,
